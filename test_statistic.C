...
//=====================================================================================================
//================================ Generate distributions under t =====================================
//=====================================================================================================
...
Xdist_b->SetLineColor(kRed);
Xdist_bs->SetLineColor(kBlue);
green->SetLineColorAlpha(kRed,0.01);
yellow->SetLineColorAlpha(kRed,0.01);
...
AddText(0.4, 0.930, Form(" %3.2f ",X_obs),0.0450, 0.,"right"); // t_obs
AddText(0.5, 0.930, Form(" %3.2f ",X_bs_med),0.0450, 0.,"right"); // median H_1
AddText(0.6, 0.930, Form(" %3.2f ",X_b_med),0.0450, 0.,"right"); // median H_0

AddText(0.95, 0.95, Form("#MC sim. in total: %3i ",Ntoys),0.0450, 0.,"right"); // X-axis
